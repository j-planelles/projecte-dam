...
DESCRIPCIONS_USUARIS = [
    "Entrenador personal apassionat pel fitness i la salut.",
    "Especialista en entrenaments de força i tonificació.",
    "Ajudo a aconseguir els teus objectius físics amb motivació.",
    ...
    "Entrenador de crossfit i entrenaments d’alta intensitat.",
    "T’acompanyo en el teu canvi físic i mental.",
    "Entrenador per a esportistes d’elit i amateurs.",
    "Especialista en entrenaments per a dones.",
    "Entrenador de gimnàs amb enfocament motivacional.",
    "Entrenaments per a millorar la postura i la mobilitat.",
    "Entrenador personal amb atenció individualitzada.",
    ...
    "Entrenador de gimnàs i assessor nutricional.",
    "Entrenador de fitness amb energia positiva.",
    "Entrenaments per a millorar la teva qualitat de vida.",
    "Entrenador personal amb resultats demostrats.",
    "Entrenador de gimnàs per a principiants i avançats.",
    "Entrenador motivador i compromès amb els teus objectius.",
]
