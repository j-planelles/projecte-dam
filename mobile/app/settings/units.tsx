      ...
      <ScrollView>
        <View className="pt-4 gap-4">
          <View className="mx-4 gap-2">
            ...
            <Text variant="bodyMedium">You can change the units temporally in the current workout page. Changing these options will not reflect recorded activity.</Text>
            <ChoiceBox
              mode="outlined"
              label="Weight Units"
