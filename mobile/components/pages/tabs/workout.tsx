...
export default function WorkoutTab() {
  return (
    <HomeTabsScreen>
      ...
      <Button icon={({ color }) => <AddIcon color={color} />} mode="contained">
  ...
  return (
    <>
      <View className="flex-1 flex-row items-center">
        ...
        <TouchableRipple onPress={() => router.push("/workout/template-view/")} className="p-2">
          <AddIcon />
        </TouchableRipple>
      </View>

      <WorkoutCard onPress={() => router.push(`/workout/template-view/carlos`)} showTimestamp={false} showDescription={true}/>
    </>
  );
};
