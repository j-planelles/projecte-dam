export const SAMPLE_WORKOUTS: workout[] = [
    ...
    exercises: [
      {
        exercise: {
          ...
          type: "barbell",
          bodyPart: "legs",
          description: "Classic compound movement targeting quadriceps, hamstrings, and glutes"
        },
        sets: [
          { reps: 10, weight: 135 },
          { reps: 8, weight: 155 },
      ...
      },
      {
        exercise: {
          ...
          type: "barbell",
          bodyPart: "chest",
          description: "Horizontal pressing movement for chest, shoulders, and triceps"
        },
        sets: [
          { reps: 10, weight: 135 },
          { reps: 8, weight: 155 },
    ...
    exercises: [
      {
        ...
        sets: [
          { reps: 1, weight: 0 } // 20 minutes straight
        ]
      },
      {
        exercise: {
  ...
  },
  {
    ...
    description: "Technical Olympic lifting workout for power and explosiveness",
    exercises: [
      {
        exercise: {
  ...
  },
  {
    ...
    gym: "CrossFit Zone",
    creator: "Lisa Wang",
    description: "Movements that mimic everyday activities for practical strength",
    exercises: [
      {
        exercise: {
  ...
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        sets: [
          { reps: 10, weight: 0 } // 10 minutes of various stretches
        ]
      },
      {
        exercise: {
        ...
        sets: [
          { reps: 1, weight: 0 } // 5 minutes on various body parts
        ]
      }
    ]
  },
    ...
    exercises: [
      {
        ...
        sets: [
          { reps: 1, weight: 0 } // 5 minutes straight
        ]
      },
      {
        exercise: {
        ...
        sets: [
          { reps: 3, weight: 0 } // 3 rounds of 3 minutes
        ]
      },
      {
        exercise: {
      ...
      },
      {
        ...
        sets: [
          { reps: 2, weight: 0 } // 2 rounds of 2 minutes
        ]
      },
      {
        exercise: {
        ...
        sets: [
          { reps: 3, weight: 0 } // 3 rounds of 2 minutes
        ]
      }
    ]
  },
...
export const SAMPLE_EXERCISES: exercise[] = [
  ...
  },
  {
    ...
    bodyPart: "back",
    description: "Vertical pulling with assistance for those unable to do full pull-ups"
  },
  {
    uuid: "ex23-6w7x-8y9z-1a2b-3c4d",
    name: "Assisted Dip",
    type: "assisted-bodyweight",
    bodyPart: "chest",
    description: "Pushing exercise with assistance for those unable to do full dips"
  },
  {
    uuid: "ex24-7x8y-9z1a-2b3c-4d5e",
