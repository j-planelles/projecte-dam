...
/**
 * @typedef trainer
 * @description Defineix l'estructura de dades d'un entrenador.
 * @property {string} username - Nom d'usuari únic de l'entrenador.
 * @property {string} name - Nom real o visible de l'entrenador.
 * @property {string} description - Descripció o biografia de l'entrenador.
 */
type trainer = {
  username: string; // Nom d'usuari
  name: string; // Nom de l'entrenador
  description: string; // Descripció de l'entrenador
};
